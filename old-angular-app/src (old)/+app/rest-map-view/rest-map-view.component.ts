import { Component, ChangeDetectionStrategy, ViewEncapsulation, NgZone, ViewChild } from '@angular/core';
...
export class RestMapViewComponent {
  ...
  constructor(public constants: Constants, public appService: AppService, private route: ActivatedRoute, private router: Router, public shoppingCart: ShoppingCart, private zone: NgZone) {
