...
export class LoginComponent implements OnInit {
    ...
    constructor( @Inject(PLATFORM_ID) private platformId: Object, private constants: Constants, private ROService: ROService, private userService: UserService, private router: Router, private route: ActivatedRoute, public sharedDataService: SharedDataService, public input: InputService, private toastr: ToastsManager) {
    ...
    ngOnInit() {
        ...
        if (this.isBrowser) {
            this.route.queryParams.subscribe((params: any) => {
                ...
                var loginType = params.email && params.authcode ? this.LOGIN_TYPE_AUTHCODE : this.LOGIN_TYPE_PASSWORD;

                this.initPage(loginType, params);
            });
        }
    }
...
// update: 2025-07-31T20:15:39.327359
