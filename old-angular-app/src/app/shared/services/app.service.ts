...
export class AppService {
    ...
    verifyPhone = (requestData: APIRequestData) => {
        var request = new APIRequest();
        request.url = `${this.constants.API_URL}/b/vp.aspx?key=${this.constants.API_KEY}`;
    ...
    verifyEmail = (requestData: APIRequestData) => {
        var request = new APIRequest();
        request.url = `${this.constants.API_URL}/b/v.aspx?key=${this.constants.API_KEY}`;
    ...
    setDefaultUserPayment = (requestData: UserPaymentAPIRequestData) => {
        ...
        var request = new APIRequest();
        request.url = `${this.constants.API_URL}/b/q.aspx?key=${this.constants.API_KEY}`;
    ...
    getAppSettings = (requestData: APIRequestData) => {
        var request = new APIRequest();
        request.url = `${this.constants.API_URL}/b/ggs.aspx?key=${this.constants.API_KEY}`;
    ...
    getCities = (requestData: any) => {
        ...
        var request = new APIRequest();
        request.url = `${this.constants.API_URL}/b/seo.aspx?key=${this.constants.API_KEY}`;
