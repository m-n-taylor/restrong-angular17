...
export class ROService {
    ...
    private readonly API_PLATFORM = 'a/t';
    private readonly API_PAGES_TEXT = 'a/pd';
    private readonly API_PLATFORM_IMAGE = 'a/pi';
    private readonly API_REGISTRATION = 'a/reg';
    private readonly API_RESTAURANT = 'a/r';
    private readonly API_PAYMENT_METHODS = 'a/g';
    ...
    getItunesApp = (id?) => {
        ...
        request.url = `https://itunes.apple.com/lookup?bundleId=${id}`;

        request.method = RequestMethod.Get;

        return this.httpClient.sendRequest(request).toPromise();
    }
    ...
    getPlatformCompanies = (requestData: ROAPIRequestData) => {
        requestData.qt = 'companies';

        return this._sendRequest({
            apiURL: this.API_PLATFORM,
            requestData: requestData,
        }).promise.toPromise();
    }

    // Get Platform Settings
    getPlatformSettings = (requestData: ROAPIRequestData) => {
        requestData.qt = 'info';
    ...
    savePlatformSettings = (requestData: ROAPIRequestData, body) => {
        requestData.qt = 'info';

        requestData.act = 'update';

        (<any>requestData).IncludeIntroPages = true;

        // Util.merge(requestData, body);

        // body.IntroPages = [{a:12}];
     ...
     * Dynamic Pages Text
     */
    getAboutText = (requestData: ROAPIRequestData) => {
        requestData.qt = 'about';

        return this._sendRequest({
            apiURL: this.API_PAGES_TEXT,
            requestData: requestData,
        }).promise.toPromise();
    }

    getPrivacyPolicyText = (requestData: ROAPIRequestData) => {
    ...
    getReturnPolicyText = (requestData: ROAPIRequestData) => {
    ...
    getTermOfUseText = (requestData: ROAPIRequestData) => {
    ...
    // Upload App Icon
    _changePlatformImage = (requestData: ROAPIRequestData, formData: FormData) => {
        return this._sendRequest({
            apiURL: this.API_PLATFORM_IMAGE,
            requestData: requestData,
    ...
    // Upload App Icon
    uploadAppIconImage = (requestData: ROAPIRequestData, formData: FormData) => {
        requestData.qt = 'icon';
        requestData.act = 'upload';

        return this._changePlatformImage(requestData, formData);
    }

    // Delete App Icon
    deleteAppIconImage = (requestData: ROAPIRequestData) => {
        requestData.qt = 'icon';
        requestData.act = 'del';

        return this._changePlatformImage(requestData, null);
    }

    // Upload App Splash
    uploadAppSplashImage = (requestData: ROAPIRequestData, formData: FormData) => {
    ...
    // Delete App Splash
    deleteAppSplashImage = (requestData: ROAPIRequestData) => {
        requestData.qt = 'splash';
        requestData.act = 'del';
    ...
    // Get Payment Methods
    getPaymentMethods = (requestData: any) => {
        requestData.qt = 'list';

        return this._sendRequest({
            apiURL: this.API_PAYMENT_METHODS,
            requestData: requestData,
    ...
    // Add Payment Method
    private _addPaymentMethod = (requestData: any) => {
        requestData.qt = 'addbyowner';
    ...
    private _updatePaymentMethod = (requestData: any) => {
        requestData.qt = 'update';
    ...
    saveRestInfo = (requestData: ROAPIRequestData) => {
        ...
        delete requestData.qt;
        delete requestData.ff;
    ...
    // Get Menu Item Sizes
    getMenuItemSizes = (requestData: ROAPIRequestData) => {
    ...
    // Save Order
    saveOrder = (requestData: ROAPIRequestData, body: any) => {
