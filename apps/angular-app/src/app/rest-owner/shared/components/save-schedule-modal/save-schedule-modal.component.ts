...
export class SaveScheduleModalComponent extends BaseModal {
    ...
    constructor( @Inject(PLATFORM_ID) private platformId: Object, public constants: Constants, public eventsService: EventsService, private ROService: ROService, public helperService: ROHelperService, private toastr: ToastsManager) {
        super(eventsService);
