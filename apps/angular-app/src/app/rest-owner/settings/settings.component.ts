...
export class SettingsComponent implements OnInit {
    ...
    initPage = () => {
        ...
        this.showRestTabNav = this.userService.loginUser.ShowRestTabNav;

        this.callRestaurant = this.userService.loginUser.CallRestaurant;
    }
    ...
    save = (form) => {
        ...
        Observable.forkJoin(promiseList).subscribe((response: any) => {
            ...
            if (successSettings && successPassword) {
                ...
                this.userService.loginUser.ShowRestTabNav = this.showRestTabNav;
