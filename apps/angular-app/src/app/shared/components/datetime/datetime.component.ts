...
@Component({
	...
	template: `	<div class="form-group has-error" [ngClass]="{ 'has-error' : error }">
					...
					<div [hidden]="options.hideClear" class="text-success cursor-pointer" (click)="clear()">Clear</div>
				</div>`,
...
export class DateTimeComponent {
	...
	public defaultOptions = new DateTimeOptions();
	...
	private onChange = (selectedDates, dateStr, instance) => {
		...
		Util.log(this.LOG_TAG, 'onChange', selectedDates, this.value, dateStr, instance);
	}
